    ...
    scanf("%d", &opcion);  
     if (opcion == 1) {
        ...
        for (int x = 1; x <= 5; x++) { //For que se repite 5 veces 
            suma = suma + sumarFila(fila)+ x + sumarCara(cara); //En cada iteración del ciclo, se realiza una operación 
        }														//que suma el resultado de las funciones sumarFila y sumarCara 
        ...
        for (int x = 1; x <= 5; x++) { //nicia un ciclo for que se repetirá cinco veces, con la variable x inicializada en 1.
            for (int y = 1; y <= 5; y++) { //Inicia un ciclo for anidado que también se repetirá cinco veces, con la variable y inicializada en 1
            	suma=suma+ sumarCara(cara); //En cada iteración del ciclo anidado, se realiza una operación que suma el valor actual de suma 
